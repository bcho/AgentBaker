...
var _ = Describe("Assert generated customData and cseCmd", func() {
	DescribeTable("Generated customData and CSE", func(folder, k8sVersion string, configUpdator func(*NodeBootstrappingConfiguration)) {
		...
		Entry("AKSWindowis with k8s version 1.17", "AKSWindows+K8S117", "1.17.7", func(config *NodeBootstrappingConfiguration) {
			cs := getFakeContainerService("1.17.7")
			config.AgentPoolProfile = cs.Properties.AgentPoolProfiles[1]
		}),
		Entry("AKSWindows with k8s version 1.18", "AKSWindows+K8S118", "1.18.2", func(config *NodeBootstrappingConfiguration) {
